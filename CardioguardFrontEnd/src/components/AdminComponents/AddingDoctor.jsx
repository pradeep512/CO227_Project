...
//       const response = await axiosClient.post('/admin/createDoctor', doctorData);
//       console.log('Doctor created successfully:', response.data);
//       // Add success notification or reset form here if needed
...
//         <h2 className="text-2xl font-semibold mb-6 text-center">Create New Doctor</h2>
...
const CreateDoctorForm = () => {
  ...
  return (
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
        ...
        {error && <p className="text-red-600 mb-4 text-center">{error}</p>}
        {successMessage && <p className="text-green-600 mb-4 text-center">{successMessage}</p>} {/* Display success message */}
